...
public class OnlineLimitFilter extends AccessControlFilter {
    ...
    public OnlineLimitFilter(RedisTemplate<String, Serializable> sessionIDRedisTemplate, SessionManager sessionManager, SessionDAO sessionDAO, ShiroProperties shiroProperties) {
        this.sessionIDRedisTemplate = sessionIDRedisTemplate;
