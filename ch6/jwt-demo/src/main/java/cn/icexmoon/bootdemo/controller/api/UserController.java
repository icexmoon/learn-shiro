...
public class UserController {
    ...
    @PostMapping("/login")
    public ApiResult<Object> login(@Validated @RequestBody LoginDTO loginDTO, HttpServletResponse response) {
        try {
        ...
        // 登录成功后生成 JWT token
        String jwtToken = jwtService.encodeToken();
        response.setHeader(jwtProperties.getJwtHeaderName(), jwtToken);
