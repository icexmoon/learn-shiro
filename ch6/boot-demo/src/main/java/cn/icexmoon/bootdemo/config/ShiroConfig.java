...
import cn.icexmoon.bootdemo.core.shiro.filter.ApiAuthenticationFilter;
import cn.icexmoon.bootdemo.core.shiro.filter.OnlineLimitFilter;
...
import cn.icexmoon.bootdemo.core.shiro.sessionmanager.HeaderWebSessionManager;
...
public class ShiroConfig {
    ...
    public DefaultWebSessionManager webSessionManager() {
        DefaultWebSessionManager webSessionManager = new HeaderWebSessionManager();
        ...
        long sessionTimeOut = sessionProperties.getTimeout();
        webSessionManager.setGlobalSessionTimeout(sessionTimeOut * 1000);
    ...
    public ShiroFilterFactoryBean shiroFilterFactoryBean() {
        ...
        // 设置没有权限时跳转的地址
        shiroFilterFactoryBean.setUnauthorizedUrl("/jsp/system/error.jsp");
